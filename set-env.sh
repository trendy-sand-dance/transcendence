# export PATH_IMAGE_FRONTEND=ghcr.io/trendy-sand-dance/frontend:main
# export PATH_IMAGE_USERMANAGEMENT=ghcr.io/trendy-sand-dance/user-management:main
# export PATH_IMAGE_DATABASE=ghcr.io/trendy-sand-dance/database:main
# export PATH_BUILD_GAMESERVER=ghcr.io/trendy-sand-dance/gameserver:main
